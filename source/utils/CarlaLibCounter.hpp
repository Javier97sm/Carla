...
public:
    ...
    lib_t open(const char* const filename, const bool canDelete = true, const bool use_libbox64 = false, LoadLibraryWithEmulatorFunction loadLibraryFunction = nullptr) noexcept
    {
        ...
        const lib_t libPtr = lib_open(filename, false, use_libbox64, loadLibraryFunction);
